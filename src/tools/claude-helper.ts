...
type ClaudeHelperParams = z.infer<typeof ClaudeHelperParamsSchema>

export const claudeHelperTool: MCPTool<ClaudeHelperParams> = {
  name: 'claude_helper',
  ...
  handler: async (params: ClaudeHelperParams) => {
    const { intent } = params
